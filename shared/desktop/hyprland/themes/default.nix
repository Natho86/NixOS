# Milestone 4: theme selector. Not a NixOS option (this repo's desktop
# module is imported directly into flake.nix rather than exposing a
# desktop.hyprland.enable/options tree per the plan's §4 illustrative
...
# two real the reference implementation themes the user asked to focus on getting
